                ...
                try {
                    ...
                    while ($ultNSU <= $maxNSU) {
                        ...
                        try {
                            ...
                            $updateErro['client_forcar_download'] = '0';
                        ...
                        if (in_array($cStat, ['137', '656'])) {
                            ...
                            $updateErroNovo['client_forcar_download'] = '0';
                        ...
                        if ($ultNSU == $maxNSU) {
                            ...
                            $updateNSU['client_forcar_download'] = '0';
                    ...
                    $updateErroAnterior['client_forcar_download'] = '0';
